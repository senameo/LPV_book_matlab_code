...
% March 2025
%
% L,P,gamma_2,VP]=obs_LPVpol_pole_h2_hinf(A,B1,N,C,Cz,gamma_inf,alpha,theta,r,solver)
% Description
...
function [L,P,gamma_2,VP]=obs_LPVpol_pole_h2_hinf(A,B1,N,C,Cz,gamma_inf,alpha,theta,r,solver)
epsi = 1e-10;
[nx,nw] = size(B1{1});
[ny,nx] = size(C);
[nz,nx] = size(Cz);
